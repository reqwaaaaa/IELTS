...
* 第七章：Part1真题
  ...
  一. 必考题(**身份类**)
  - 1、Work:
    - `I relish the autonomy and creativity my job offers. It empowers me to implement my ideas and witness them come to fruition. The constant evolution of the industry also means I'm continually adapting, which I find invigorating.`
    - `My workweek varies, but on average, I find myself dedicating approximately 60 hours. The nature of my job sometimes demands extended hours, especially during peak seasons or when projects are nearing deadlines.`
    - `I am a freelancer, primarily working online from home. This setup gives me the flexibility to manage my own schedule and work with clients globally.`
  - 2、Study:
    - `I genuinely appreciate the intellectual challenge my studies offer. It allows me to expand my horizons and delve into subjects that I'm passionate about. Moreover, it equips me with valuable skills that I believe will benefit my future endeavors.`
    - `For me to study better, I think regular breaks and efficient time management are pivotal. Overloading myself leads to burnout, so having a balanced routine with short, rejuvenating breaks is essential. Also, utilizing modern study techniques can significantly boost my productivity.`
    - `At the end of a study session, I often feel mentally exhausted yet fulfilled. The journey of acquiring knowledge is taxing but also deeply rewarding.`
 
  二. 必考题(**地点类**)
  - 1、Hometown
    - `I come from SH, which is a sprawling metropolis. It's an incredible blend of historic landmarks and modern skyscrapers. Whereas on the other hand, the cost of living and competitive pressure here can be overwrought for young people`
    - `Absolutely! SH as a metropolis, offers a plethora of opportunities for young people. From top-tier universities and vibrant job markets in tech, finance, and the arts, to a dynamic nightlife and adiverse cultural scene, it's a magnet for youth seeking growth and adventure.`
  - 2、The area you live in
    - `Yes, I was born and raised in SH, so I've spent my entire life there, around 22 years. It's a place that's close to my heart. Correspondingly, it's living conditions and humanistic care are both delectable.`
    - `In SH, I wish there were more green spaces and parks. With the rapid urbanization, it would be beneficial for both the environment and residents to have more areas to relax and breathe fresh air.`

  三. 题(**social media | techniques**)
  - 1、From when you started using social media？
    - `Well, I guess use my mobile phone for texting or calls once every hour. I think it's a great tool because it facilitates quick and effective communication. I mean, it is basically an extension of my arm at this point.`

  - 2、How has your mobile phone / computer change your life?
    - `Well, I guess my mobile phone has significantly changed my life by keeping me connected and organized. I believe it's a great tool because it allows me to stay in touch with family and friends, manage my schedule, and access information instantly. My phone is basically an extension of my arm at this point. Then again My laptop's more for serious stuff like editing videos or projects coding.`

  - 3、特殊类（LLM / GitHub）
    - `You know, Openai launched its first product in 2022, which tremendously escalated the world's productivity and production methods. As a CS student, I naturally embrace new technology, frequently using LLM to gather information, organize knowledge, assist with programming, and share my insights and projects within open-source communities such as GitHub.`

  三. 题(**sports | favor**)
  - 1、Do you think it is difficult to learn a new language?
    - `Definitely. Whereas some people tend to suppose that learning a new language is easy if you practice regularly, but as for me I believe it requires a lot of dedication and effort. The primary reason is that mastering a new language involves not only learning vocabulary and grammar but also understanding cultural nuances and context.`
  - 2、体育运动经历，意义，建议
    - `Well obviously, I belive I have a good figure. This is due to my years of scientific fitness training. I enjoy spending one hour exercising in the gym each day, which makes me delectable both physically and mentally.`
    - `Any sort of sports, You know, it's significance goes beyond just physical exercise, it also involves establishing good dietary and lifestyle habits. I mean, the positvie attitude towards life like striving for a better tomorrow. Therefore, I suggest that everyone should develop their own sports hobbies.`
...
* 第八章：Part2真题
  ...
  - Describe a person who encouraged and helped you to achieve a goal. You should say:
    - who this person is（**CS teacher/ Mr Yang**）
    - what this person encouraged you to do（**challenge and concentrate myself**）
